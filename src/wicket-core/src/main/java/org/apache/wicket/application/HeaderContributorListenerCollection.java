...
/**
 * A collection for application level registration of {@link IHeaderContributor}s
 */
public class HeaderContributorListenerCollection extends ListenerCollection<IHeaderContributor>
	implements
		IHeaderContributor
{
